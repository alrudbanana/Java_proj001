...
public class Multi_Catch01 {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println( 3/0 ); //실행시 예외 (ArtimeticException)
		...
		try {
		int num = Integer.parseInt("10A");	//실행시 예외( NumberformatException)
		...
		//2. 하나의 try ~ catch 에서 한번에 처리 
			// 각각의 예외에 대해서 각각 처리 하도록 함.
