...
public class RectangleArrayDefinition {
	...
	public static void main(String[] args) {
		...
		// -비정방형 배열 		: row(행) 에 대해서 열 (column,field)이 동일하지 않은 배열 
		...
		int [][] arr1 = new int [3][4] ; // 3: 행의 갯수 ( 0, 1, 2) 
			...
			//4. 정방향 배열 선언과 동시에 값넣기 : <주의> 방크기를 지정하면 오류 발생
			System.out.println("=============================");
			...
			System.out.println(arr12[0][2]); //23
			
			//5. 정방향 배열 선언과 동시에 값 넣기 2
			int[][] arr13 = {{100,110,123}, {210,220,230}};
